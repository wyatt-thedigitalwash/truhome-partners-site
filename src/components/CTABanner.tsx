      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <FadeIn delay={0.2}>
          <Link
            ...
            className="group mt-10 inline-flex items-center gap-2 rounded-xl bg-white px-10 py-4 text-base font-bold text-[#2F343A] shadow-lg transition-all duration-200 ease-out hover:bg-[#F5F5F5] hover:scale-[1.03] hover:shadow-[0_0_30px_rgba(245,240,235,0.15)] active:scale-[0.97]"
          >
            Get My Cash Offer
            <ArrowRight
              size={18}
